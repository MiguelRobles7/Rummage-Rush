extends Spatial
onready var trash = preload("res://Interactable Objects/Trash.tscn")
onready var trash2 = preload("res://Interactable Objects/Trash2.tscn")
onready var trash_container = get_node("TrashContainer")
onready var segMetal = preload("res://Interactable Objects/SegMetal.tscn")
onready var segMetalContainer = get_node("SegMetalContainer")
onready var segPlastic = preload("res://Interactable Objects/SegPlastic.tscn")
onready var segPlasticContainer = get_node("SegPlasticContainer")
onready var segRubber = preload("res://Interactable Objects/SegRubber.tscn")
...
onready var hazards = preload("res://Interactable Objects/Hazard.tscn")
onready var hazards2 = preload("res://Interactable Objects/Hazard2.tscn")
